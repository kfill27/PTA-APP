...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { email: @membership.email, name: @membership.name, phone: @membership.phone } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { email: @membership.email, name: @membership.name, phone: @membership.phone } }
